...
internal sealed class KestrelSocketConnection : ISocketConnection
{
    ...
    internal KestrelSocketConnection(Socket socket,
    ...
    public void Start()
    {
        ...
        {
            Console.WriteLine($"Unexpected exception in {nameof(KestrelSocketConnection)}.{nameof(Start)}.");
        }
    }
    ...
    private void Shutdown(Exception? shutdownReason)
    {
        lock (_shutdownLock)
        {
            ...
            _shutdownReason = shutdownReason ??
                              new ConnectionAbortedException("The Socket transport's send loop completed gracefully.");
    ...
    private void CancelConnectionClosedToken()
    {
        ...
        {
            Console.WriteLine(
                $"Unexpected exception in {nameof(KestrelSocketConnection)}.{nameof(CancelConnectionClosedToken)}.");
        }
    }
